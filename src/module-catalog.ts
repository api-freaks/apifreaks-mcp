...
export const MODULE_CATALOG = {
  ...
  commodity: {
    summary: "Live/historical prices (245+), fluctuation, time series, symbols",
    tools: [
      { name: "commodity_latest_rates", summary: "Latest prices; freshness is per-symbol updateInterval" },
      { name: "commodity_historical_rates", summary: "Historical OHLC prices from 1990" },
      { name: "commodity_fluctuation", summary: "Price change over a range" },
      { name: "commodity_time_series", summary: "Daily OHLC over a range (max 365 days)" },
      { name: "commodity_symbols", summary: "Supported commodity symbols" },
      { name: "commodity_symbol_info", summary: "Look up one symbol, including updateInterval" },
